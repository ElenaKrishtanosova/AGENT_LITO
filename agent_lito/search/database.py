...
class DatabaseSearcher:
    ...
    def _generate_embeddings_sync(self, text: str) -> Optional[str]:
        """
        Синхронная версия генерации эмбеддингов для тестирования
        """
        try:
            response = self.openai_client.embeddings.create(
                input=text,
